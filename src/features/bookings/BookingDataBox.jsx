...
const Price = styled.div`
  ...
  background-color: ${(props) =>
    props.prepaid ? "var(--color-green-100)" : "var(--color-yellow-100)"};
  color: ${(props) =>
    props.prepaid ? "var(--color-green-700)" : "var(--color-yellow-700)"};
    ...
    <StyledBookingDataBox>
      ...
      <Section>
        ...
        <Price prepaid={prepaid}>
          ...
          <p>{prepaid ? "Paid" : "Will pay at property"}</p>
        </Price>
      </Section>
